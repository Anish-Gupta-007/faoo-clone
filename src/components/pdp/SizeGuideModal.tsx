...
export function SizeGuideModal({ isOpen, onClose, sizeChartUrl }: SizeGuideModalProps) {
  return (
      ...
      <div className="px-6 pb-6">
        {sizeChartUrl ? (
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="relative w-full overflow-hidden bg-white border border-[#EFEFEF] rounded-lg shadow-sm flex items-center justify-center p-2">
              <img
                src={sizeChartUrl}
                alt="Size Chart"
